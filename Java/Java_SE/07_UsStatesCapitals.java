...
public class UsStatesCapitals 
{
	...
	public class PanelPrimary extends JPanel
	{
		private JLabel inputLabel, outputLabel, resultLabel, 
		               inputRegexLabel, outputRegexLabel;
	...
	private static void readFile() 
	{
		...
		if (f.isDirectory()) die(file + " is a directory.");
		if (!f.canRead()) die("You cannot read " + file + " .");
	} // end of readFile(). 
	...
	public static void main(String[] args)
	{
		...
		{	
			...
			public void run() 
			{
				...
				UsStatesCapitals.PanelPrimary panelPrimary = 
				        usStatesCapitals.new PanelPrimary();
