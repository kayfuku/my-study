	...
	public class Panel0 extends JPanel
	{
		...
		{	
			...
			{		
				...
				g.fillRect(20 + BAR_WIDTH + BAR_GAP, 
					       BAR_BOTTOM - gHeight, 
					       BAR_WIDTH, gHeight);
				// Blue bar.
				g.setColor(Color.BLUE);
				g.fillRect(20 + BAR_WIDTH * 2 + BAR_GAP * 2, 
					       BAR_BOTTOM - bHeight, 
					       BAR_WIDTH, bHeight);
				// Color Oval.
		...
		{
			private JRadioButton decimalButton, binaryButton, 
			                     hexButton, octalButton;
			...
			private class RadioListener implements ChangeListener
			{
				...
				public void stateChanged(ChangeEvent event)
				{
					...
					{
						rLabel.setText("Red:  " + 
							Integer.toHexString(rValue));
						gLabel.setText("Green:  " + 
							Integer.toHexString(gValue));
						bLabel.setText("Blue:  " + 
					...
					{
						rLabel.setText("Red:  " + 
							Integer.toOctalString(rValue));
						gLabel.setText("Green:  " + 
							Integer.toOctalString(gValue));
						bLabel.setText("Blue:  " + 
							Integer.toOctalString(bValue));	
						radixFlag = 8;
					}
				}	
