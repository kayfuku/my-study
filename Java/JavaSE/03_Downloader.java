...
public class Downloader 
{
    ...
    public static synchronized void changeByteOrIndicator(
    	                           int nByte, char charIndicator)
    {
    	System.out.print("\r");
		System.out.printf("Downloading " + strFileName + 
				    	  " ... %8d" + " Byte", nByte);
		System.out.print("  ");
		...
		Thread thread1 = new Thread(new Runnable()
		{
			...
			public void run() 
			{
				while (!isDownloaded)
				{
					...
					changeByteOrIndicator(totalDownloadedByte, 
						                  charIndicator);
		...
		Thread thread2 = new Thread(new Runnable()
		{
			...
			public void run() 
			{
				while (!isDownloaded)
				{
					...
					changeByteOrIndicator(tempByte, 
						                  charIndicator);
